...
const url="mongodb://scls:scls@cluster0-shard-00-00-r4eto.mongodb.net:27017,cluster0-shard-00-01-r4eto.mongodb.net:27017,cluster0-shard-00-02-r4eto.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority";
...
app.post('/save',(request,response)=>{
 ...
 dbo.collection("studentid").find({gyear:request.body.gyear,gbranch:request.body.gbranch}).toArray((error,res)=>{
    ...
    if(error){
     ...
     {
        response.send({message:"CmsGenerate first"})
     }
     else{
